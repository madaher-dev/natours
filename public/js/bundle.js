...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFkYWhlciIsImEiOiJja2RiYnd5eHgxbTZpMnBzY2xwaGNoMTBqIn0.Z6vwWcnI0dTtNM0mvPxiOg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/madaher/ckdbc93tc21181ipuxf5n3orj',
    scrollZoom: false // center: [-118.1407587, 34.176268],
    // zoom: 4,
    // interactive: false;
